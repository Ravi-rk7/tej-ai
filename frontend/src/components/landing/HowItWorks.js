...
const STEPS = [
  {
    ...
    desc: "Take a clear, bare-faced selfie in natural light. The image is sent securely to our analysis provider and is not stored by TejAi.",
    color: "#5845cb",
    bg: "#e4dfff",
    delay: "0ms",
  },
  ...
  },
  {
    ...
    desc: "Receive your Glow Score, cosmetic concern summary, and a personalized morning and night wellness routine.",
    color: "#a01e96",
    bg: "#ffd7f3",
    delay: "300ms",
  },
